...
public class CamaraActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        Rect rect1 = new Rect(0, 0, screenWidth / 6, screenHeight);
        ...
        Imgproc.rectangle(matInput, rect1.tl(), rect1.br(), new Scalar(245, 45, 145, 1), 2);
    ...
    private void capturarRoi() {
        ...
        try {
            ...
            if (m_mathRoi != null) {
                ...
                Intent intent = new Intent(CamaraActivity.this, AdapterActivity.class);
